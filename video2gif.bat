...
REM Version: 1.0.1
REM Url: https://github.com/kimberleyvarona/videotogif
...
IF "%input%" == "" (
    ECHO Video to GIF converter v1.0.0 ^(C^) 2020, Kim Varona ^<kimvarona.acads@gmail.com^>
    ECHO You can download it from here: https://github.com/kimberleyvarona/videotogif
    ECHO.
